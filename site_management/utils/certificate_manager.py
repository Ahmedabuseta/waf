...
class CertificateManager:
    ...
    def verify_dns_challenge_and_generate_cert(self, domain: str, email: str,
        ...
        try:
            ...
            # Step 1: DNS Verification Note
            # We use public DNS servers (8.8.8.8, 1.1.1.1) in ACMEDNSManager to avoid ISP DNS cache issues
            print(f"🔍 Using public DNS servers (Google DNS, Cloudflare DNS) for verification...")
            print(f"   This avoids ISP DNS cache that may have stale values")
