...
sys.path.insert(0, str(Path(__file__).parent.parent.parent / "site_mangement"))
    ...
    def generate_wildcard_certificate_acme(self, domain: str, email: str,
        ...
        try:
            ...
            if not self._check_acme_sh_available():
                print("❌ acme.sh not found. Please install acme.sh first.")
                print("   Installation: curl https://get.acme.sh | sh")
                return False
            ...
            if result.returncode != 0:
                ...
                print("   Please ensure you added the DNS TXT records correctly")
                return False
            ...
            if self._copy_acme_certificates_to_domain_dir(domain, domain_dir):
                ...
                print("❌ Failed to copy certificates to domain directory")
                return False

        except subprocess.TimeoutExpired:
            print("❌ acme.sh process timed out")
            print("   The manual DNS validation process took too long")
            return False
        except Exception as e:
