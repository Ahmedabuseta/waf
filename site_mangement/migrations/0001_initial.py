    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ssl_certificate', models.FileField(blank=True, null=True, upload_to=site_mangement.models.ssl_upload_path, verbose_name='SSL Certificate')),
                ('ssl_key', models.FileField(blank=True, null=True, upload_to=site_mangement.models.ssl_upload_path, verbose_name='SSL Key')),
                ('ssl_chain', models.FileField(blank=True, null=True, upload_to=site_mangement.models.ssl_upload_path, verbose_name='SSL Chain')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='analytics', to='site_mangement.site', verbose_name='Site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='logs', to='site_mangement.site', verbose_name='Site')),
            ],
            options={
                'verbose_name': 'Log',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('site', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='load_balancer', to='site_mangement.site', verbose_name='Site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='geographic_stats', to='site_mangement.site', verbose_name='Site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='email_reports', to='site_mangement.site', verbose_name='Site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='addresses', to='site_mangement.site', verbose_name='Site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analytics', models.ManyToManyField(blank=True, related_name='alerts', to='site_mangement.requestanalytics', verbose_name='Related Analytics')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='threat_alerts', to='site_mangement.site', verbose_name='Site')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='site',
            name='WafTemplate',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sites', to='site_mangement.waftemplate', verbose_name='WAF Template'),
        ),
        migrations.AddIndex(
            model_name='requestanalytics',
            index=models.Index(fields=['site', 'timestamp'], name='site_mangem_site_id_7e701c_idx'),
        ),
        migrations.AddIndex(
            model_name='requestanalytics',
            index=models.Index(fields=['site', 'country_code'], name='site_mangem_site_id_151968_idx'),
        ),
        migrations.AddIndex(
            model_name='requestanalytics',
            index=models.Index(fields=['site', 'action_taken'], name='site_mangem_site_id_1a3524_idx'),
        ),
        migrations.AddIndex(
            model_name='requestanalytics',
            index=models.Index(fields=['ip_address', 'timestamp'], name='site_mangem_ip_addr_e60954_idx'),
        ),
        migrations.AddIndex(
            model_name='geographicstats',
            index=models.Index(fields=['site', 'date'], name='site_mangem_site_id_0e43b2_idx'),
        ),
        migrations.AddIndex(
            model_name='geographicstats',
            index=models.Index(fields=['site', 'country_code', 'date'], name='site_mangem_site_id_047272_idx'),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['ip_address', 'port'], name='site_mangem_ip_addr_70f0bf_idx'),
        ),
        migrations.AddIndex(
            model_name='threatalert',
            index=models.Index(fields=['site', 'timestamp'], name='site_mangem_site_id_be9b73_idx'),
        ),
        migrations.AddIndex(
            model_name='threatalert',
            index=models.Index(fields=['is_resolved', 'severity'], name='site_mangem_is_reso_3ebdaa_idx'),
        ),
        migrations.AddIndex(
            model_name='site',
            index=models.Index(fields=['host'], name='site_mangem_host_72929c_idx'),
        ),
        migrations.AddIndex(
            model_name='site',
            index=models.Index(fields=['slug'], name='site_mangem_slug_bed313_idx'),
        ),
    ]
