...
MIDDLEWARE = [
    ...
    'site_mangement.middleware_examples.RequestIDMiddleware',           # Add request IDs
    'site_mangement.middleware_examples.RequestLoggingMiddleware',      # Log requests
    'site_mangement.middleware_examples.IPWhitelistMiddleware',         # IP filtering
    'site_mangement.middleware_examples.RequestSizeLimitMiddleware',    # Size limits
    'site_mangement.middleware_examples.MaintenanceModeMiddleware',     # Maintenance mode
    'site_mangement.middleware.AnalyticsMiddleware',                    # Analytics
    'site_mangement.waf_middleware.WAFMiddleware',                      # WAF rules
    'site_mangement.proxy_middleware.ProxyMiddleware',                  # Proxy forwarding
    'site_mangement.middleware_examples.SecurityHeadersMiddleware',     # Security headers
]
